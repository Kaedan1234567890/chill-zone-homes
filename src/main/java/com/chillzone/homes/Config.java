...
public final class Config {
    ...
    public int maximumVisibleSlots = 18;
    ...
    private static Config sanitize(Config c) {
        c.defaultHomes = Math.max(1, c.defaultHomes);
        c.maximumVisibleSlots = Math.max(c.defaultHomes, Math.min(45, c.maximumVisibleSlots));
